...
# cuda-toolkit pulls in cuda-visual-tools → cuda-nsight/nvvp → jre, not available on Fedora.
# Install individual components: compiler, runtime headers, and GPU libraries.
